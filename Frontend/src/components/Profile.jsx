            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                ...
                <div className='my-5'>
                    <div className='flex items-center gap-3 my-2'>
                        <Mail/>
                        <span>ashirwadbappy@gmail.com</span>
                    </div>
                    <div className='flex items-center gap-3 my-2'>
                        <Contact/>
                        <span>7237017755</span>
                    </div>
                </div> 
                <div>
                    ...
                    <div className='flex items-center gap-3'>
                    {
                        skills !== 0 ? skills.map((item, index) => <Badge key={index} variant="outline">{item}</Badge>) : <h1>No Skills Found</h1>
                    }
                    </div>               
                </div>
                <div className='grid gap-1.5 w-full max-w-sm items-center'>
                    ...
                    {
                        isResume ? <a href="https://google.com/" target='_blank' className='text-blue-500 hover:underline  cursor-pointer w-full'>See Resume</a> : <span>NA</span>
                    }
                </div>                       
            </div>
