        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                ...
                <div className='grid gap-1.5 w-full max-w-sm items-center'>
                    ...
                    {
                        isResume ? <a target='blank' href={user?.profile?.resume} className='text-blue-500 w-full hover:underline cursor-pointer'>{user?.profile?.resumeOriginName}</a> : <span>NA</span>
                    }
                </div>                       
            </div>
